...
/* STREAMING_CHUNK:Cleaning the BusinessDetailStep component... */
import React from "react";

export default function BusinessDetailStep({ formData, updateField, previousStep, nextStep }) {
  const handleSubmit = (e) => {
    e.preventDefault();
    nextStep();
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="p-8">
      <h2 className="text-2xl font-bold mb-6 text-slate-800">Business Details</h2>
