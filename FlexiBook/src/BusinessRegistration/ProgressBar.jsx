      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row items-start gap-8">
        ...
        <div className="flex-1 w-full max-w-full">
          ...
          <div className="transition-all w-full">
            ...
            {currentStep > 5 && (
              <div className="bg-white p-10 md:p-16 rounded-2xl border border-slate-200 text-center shadow-sm flex flex-col items-center animate-in fade-in zoom-in duration-500">
                <div className="w-24 h-24 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-5xl mb-6 shadow-inner ring-8 ring-green-50">
                  ✓
                </div>
                <h3 className="text-3xl font-bold text-slate-800 mb-4">Registration Complete!</h3>
                <p className="text-slate-500 mb-8 max-w-md mx-auto text-lg">
                  Welcome aboard! Your business <span className="font-semibold text-slate-700">{formData.businessName || "details"}</span> has been successfully registered. You can now access your dashboard to manage appointments and live queues.
                </p>
                <button 
                  onClick={() => window.location.reload()} 
                  className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-200 hover:shadow-lg w-full sm:w-auto"
                >
                  Go to Dashboard →
                </button>
              </div>
