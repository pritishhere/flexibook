          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.openTime) setErrors({ ...errors, openTime: null });
              }}
              className={`w-full rounded-xl border px-4 py-3 focus:outline-none transition-colors
                ${errors.openTime ? "border-red-500 focus:border-red-600 bg-red-50" : "border-slate-300 focus:border-blue-600 bg-white"}`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.closeTime) setErrors({ ...errors, closeTime: null });
              }}
              className={`w-full rounded-xl border px-4 py-3 focus:outline-none transition-colors
                ${errors.closeTime ? "border-red-500 focus:border-red-600 bg-red-50" : "border-slate-300 focus:border-blue-600 bg-white"}`}
            />
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6">
        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between rounded-xl border border-slate-300 bg-white px-5 py-4">
            ...
            <input
              type="checkbox"
              checked={formData.appointmentRequired || false}
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-300 bg-white px-5 py-4">
            ...
            <input
              type="checkbox"
              checked={formData.emergencySupport || false}
              onChange={(e) => updateField("emergencySupport", e.target.checked)}
              className="h-5 w-5 accent-blue-600 cursor-pointer"
            />
          </div>
        </div>
